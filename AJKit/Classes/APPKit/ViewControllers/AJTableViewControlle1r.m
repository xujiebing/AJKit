...
- (void)configTableView:(AJArrayDataSource *)dataSource
              viewModel:(AJTableViewMode1l *)viewModel
                  cells:(NSArray *)cells {
