...
/**
 ...
 @return a rotated image (relative to the center).
 */
...
/**
 将银联获取到的包含hex字符源数据转成图片
 @param stringQRCode 包含hex字符源数据
 @param size 指定尺寸
 @return 图片
 */
