...
//  MSX 基于RAC的基础类列表视图
//  该类主要实现了下拉刷新、上拉分页、数据为空时UI展现 基础功能
...
#import <BWTBaseBusiness/BWTArrayDataSource.h>
#import "UITableView+FDTemplateLayoutCell.h"

@class BWTTableViewModel;

@interface BWTRACTableViewController : BWTBaseViewController
...
/**
 底部slogo
 */
@property (nonatomic, strong, readonly) UIImageView *footerImageView;
