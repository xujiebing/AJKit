...
typedef enum {
	/** No error. */
	AJSSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	AJSSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	AJSSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	AJSSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	AJSSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	AJSSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	AJSSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	AJSSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	AJSSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	AJSSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	AJSSKeychainErrorFailedToDecode = errSecDecode
} AJSSKeychainErrorCode;

extern NSString *const kAJSSKeychainErrorDomain;

/** Account name. */
extern NSString *const kAJSSKeychainAccountKey;
 ...
 */
extern NSString *const kAJSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kAJSSKeychainClassKey;

/** Item description. */
extern NSString *const kAJSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kAJSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kAJSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kAJSSKeychainWhereKey;
...
/**
 ...
 AJSSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface AJSSKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in AJSSKeychain.h for a list of keys that can be used when accessing the
